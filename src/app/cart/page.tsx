...
import { CartItemsType, ShippingData } from "@/types";
              ...
              >
                ...
                <div className="flex-1 ml-4">
                  <div className="">
                    ...
                    <p className="text-xs text-gray-500">Size: {cartItem.selectedSize}</p>
                    <p className="text-xs text-gray-500">Colour: {cartItem.selectedColor}</p>
                  </div>
                  <p className="font-medium">${cartItem.price.toFixed(2)}</p>
                </div>

                <button className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 flex items-center justify-center p-2 cursor-pointer">
                  <Trash2 />
                </button>
              </div>
            ))
